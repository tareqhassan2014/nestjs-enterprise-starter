...
Administrative Nest controllers under `/api/v1/admin`: permission-gated, enveloped routes for operators, documented distinctly from end-user and non-envelope surfaces.
