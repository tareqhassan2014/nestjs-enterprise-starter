...
Generated OpenAPI/Swagger documentation for Nest routes: distinct security schemes for session cookie, session bearer, and agent API keys, with operations declaring the credentials they accept.
