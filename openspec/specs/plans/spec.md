...
Commercial plan catalogue (Lite / Pro / optional Enterprise), code-declared entitlement vocabulary with per-plan boolean values, per-plan usage-limit matrices, and the Nest entitlement/plan gate that runs after RBAC.
