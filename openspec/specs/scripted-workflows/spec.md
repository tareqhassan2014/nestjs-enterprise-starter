...
Root Makefile (and documented aliases) wrapping existing pnpm and Compose workflows for common contributor loops without replacing package scripts as the source of truth.
